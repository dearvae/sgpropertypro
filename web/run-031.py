#!/usr/bin/env python3
"""执行 031_restore_client_view_notes_edit：恢复 get_client_view 双 Token、can_edit、备注展示"""
import os
import sys
...
def main():
    ...
    script_dir = Path(__file__).resolve().parent
    sql_path = script_dir / 'supabase' / 'migrations' / '031_restore_client_view_notes_edit.sql'
    with open(sql_path, 'r', encoding='utf-8') as f:
        sql = f.read()

    print('正在执行 031（恢复 get_client_view：双 Token、can_edit、备注展示）...')
