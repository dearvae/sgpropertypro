#!/usr/bin/env python3
"""
执行 044 迁移：get_agent_listings RPC（中介公开房源主页）

用法: python3 run-migration-044.py 或 SUPABASE_DB_PASSWORD=密码 python3 run-migration-044.py
"""
import os
import sys
...
def main():
    ...
    print('正在执行 044 迁移（get_agent_listings RPC）...')
    with open(migrations_dir / '044_get_agent_listings.sql', 'r', encoding='utf-8') as f:
        sql = f.read()
